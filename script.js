...
function start() {
  ...
  const gameOver = () => {
    endScreen.innerHTML = `<div class="gameOver">Game Over :( Nous sommes tous contaminé! <br/>score : ${count} </div>`;
  ...
  const youWin = () => {
    ...
    endScreen.innerHTML = `<div class="youWin">Bravo! Le covid19 a disparu :') <br/><span>Accuarcy: ${accuracy} %</span></div>`;
    endScreen.style.visibility = 'visible';
    endScreen.style.opacity = '1';
    loopPlay = false; 
  };
